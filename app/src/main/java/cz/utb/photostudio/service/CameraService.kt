...
class CameraService {
    ...
    // Application context and textureView for displaying camera image
    ...
    // Image reader - used for capturing images from the camera
    ...
    // Callback for capturing images and processing them with AI
    ...
    private fun openCamera(): Boolean {
        ...
        try {
            ...
            // Initialize image reader for capturing snapshots
    ...
    private var textureListener: SurfaceTextureListener = object : SurfaceTextureListener {
        ...
        override fun onSurfaceTextureUpdated(surfaceTexture: SurfaceTexture) {
            ...
            if (bitmap != null) {
                copyBitmap = bitmap.config?.let { bitmap.copy(it, true) }
